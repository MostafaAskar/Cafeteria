        ...
        ">
            <div class="auth-box border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" action="handleLogin.php" method="post">
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" required="" name="email" />
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
